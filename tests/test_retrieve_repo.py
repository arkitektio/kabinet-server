...
async def test_parse_deployments(db: typing.Any) -> None:
    ...
    with open(build_relative_dir("deployments/deployments.yaml"), "r") as deployment_file:
    ...
    assert config.deployments[0].flavour == "vanilla", "First deployment should be vanilla"
    ...
    assert definition.name == "Print String", "First definition should be named Print String"
